...
const CallingDataSchema = new mongoose.Schema(
  {
    ...
    job_Title: { type: String, trim: true, required: true },
    company_Name: { type: String, trim: true, required: true },
    contact_City: { type: String, trim: true, required: true },
    contact_State: { type: String, trim: true },
    contact_Region: { type: String, trim: true },
    mobile_No1: { type: Number, required: true },
    mobile_No2: { type: Number },
